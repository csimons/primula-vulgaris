...
public class RBNCreator {
    ...
    private Map<String, Rel> relations;// the relations are stored here not to be repeated
...
//    
    public RBNCreator(File mlnf) {
        ...
        relations = new TreeMap<String, Rel>();
...
//            secondParser.ReadMarkovLogicNetwork();
    ...
    public void createRelation(ParsedRelation relation) {
        ...
        Rel rel = new Rel(relation.getRelationName(), relation.getArguments().size(), typesOfRelation);
    ...
    public Type newTypeDeclared(String type){
        ...
        if(types.containsKey(type))        
            ...
            DeclaredType newType = new DeclaredType(new TypeRel(new Rel(type,1)));
    ...
    public ProbForm createFormulaEquality(String var1, String var2){
    	return new ProbFormSFormula(new CConstrEq(var1,var2));
    }
    ...
    public void fileFinished() {
        ...
        for (ProbForm formula : formulas) {
            ...
            Rel relation = new Rel("MLNRel" + currentForm,formula.freevars().length,freetypes);
         ...
         */ 
        Vector<Rel> rels = new Vector(relations.values());
        for (Rel rel: rels){
    ...
    public Map<String,Rel> getRelations(){
